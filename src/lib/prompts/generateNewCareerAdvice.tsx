// lib/prompts/generateNewCareerAdvicePrompt.tsx

const generateNewCareerAdvicePrompt = (resumeText: string, previousAdvice?: string) => {
    return `You are a career development assistant. Your job is to analyze the resume content provided and return actionable, structured feedback to help improve the resume and boost the candidate's career prospects.
  ...
  ${previousAdvice ? `
  IMPORTANT:
  - The candidate has already received the following advice: 
  ${previousAdvice}
  - Provide entirely new and *different* advice from what was previously given. All advice gievn must be completely different from the advice already gievn. Avoid repeating tips or recommendations.` : ''}
  ...
  export default generateNewCareerAdvicePrompt;
